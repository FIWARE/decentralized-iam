...
The FIWARE Decentralized Identity and Access Management based on Verifiable Credentials (IAM4VC) is an integrated suite of components designed to facilitate authentication using Verifiable Credentials (VCs) and authorization based on ODRL policies.
...
- [Decentralized IAM (IAM4VC)](#decentralized-iam-iam4vc)
  - [Overview](#overview)
